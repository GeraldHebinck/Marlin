 ...
 */
#define E0_AUTO_FAN_PIN PF9
#define E1_AUTO_FAN_PIN PF9
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   374.5         // Set this to the distance between toolheads when both heads are homed
...
#define HOMING_BACKOFF_POST_MM { 2, 2, 5 }  // (mm) Backoff from endstops after homing
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  .04     // (steps or mm) Steps or millimeter distance for each Z babystep
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Center T0"
  #define USER_GCODE_2 "T0\n\nG1 Z5 F600\nG1 X155 Y155 F6000\nG1 Z0"

  #define USER_DESC_3 "Center T1"
